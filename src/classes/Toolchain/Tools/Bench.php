 ...
 * @since 2021-12-15
 */
class Bench extends \Clever_Canyon\Utilities\OOPs\Version_1_0_0\Base {
	/**
	 ...
	 *
	 * @throws Exception When attempting to run from anything other than a CLI.
	 */
	public static function scratch( ...$args ) : void {
		if ( ! U\Env::is_cli() ) {
